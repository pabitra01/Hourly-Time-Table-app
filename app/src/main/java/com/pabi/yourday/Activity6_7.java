...
public class Activity6_7 extends AppCompatActivity {
    ...
    DocumentReference documentReference=db.collection("DATA").document(id).collection("6_7am").document("doc");


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_67);
        ...
        getSupportActionBar().setTitle("6 AM - 7 AM");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        title_edit=findViewById(R.id.editTextTitle67);
        details_edit=findViewById(R.id.editTextDetails67);
        save_button=findViewById(R.id.save_button_67);
        title_view=findViewById(R.id.title67);
        details_view=findViewById(R.id.details67);
    ...
    protected void onStart() {
        ...
        documentReference.addSnapshotListener(this,new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent( DocumentSnapshot documentSnapshot, FirebaseFirestoreException e) {
                if(e!=null){
                    Toast.makeText(Activity6_7.this,"error",Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    public void save_data(View v){
        ...
        documentReference.set(dataOfEdittext).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                Toast.makeText(Activity6_7.this,"Successfully saved",Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Activity6_7.this,"Try again",Toast.LENGTH_SHORT).show();
            }
        });
