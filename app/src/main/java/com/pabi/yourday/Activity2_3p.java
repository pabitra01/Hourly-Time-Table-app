...
public class Activity2_3p extends AppCompatActivity {
    ...
    DocumentReference documentReference=db.collection("DATA").document(id).collection("2_3pm").document("doc");

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_activity23p);
        getSupportActionBar().setTitle("2 PM - 3 PM");
        ...
        title_edit=findViewById(R.id.editTextTitle23p);
        details_edit=findViewById(R.id.editTextDetails23p);
        save_button=findViewById(R.id.save_button_23p);
        title_view=findViewById(R.id.title23p);
        details_view=findViewById(R.id.details23p);
    ...
    protected void onStart() {
        ...
        documentReference.addSnapshotListener(this,new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent( DocumentSnapshot documentSnapshot, FirebaseFirestoreException e) {
                if(e!=null){
                    Toast.makeText(Activity2_3p.this,"error",Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    public void save_data(View v){
        ...
        documentReference.set(dataOfEdittext).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                Toast.makeText(Activity2_3p.this,"Successfully saved",Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Activity2_3p.this,"Try again",Toast.LENGTH_SHORT).show();
            }
        });
