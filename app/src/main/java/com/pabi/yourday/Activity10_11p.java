...
public class Activity10_11p extends AppCompatActivity {
    ...
    DocumentReference documentReference=db.collection("DATA").document(id).collection("10_11pm").document("doc");


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_activity1011p);
        getSupportActionBar().setTitle("10 PM - 11 PM");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        mAdView = findViewById(R.id.adView);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);
        title_edit=findViewById(R.id.editTextTitle1011p);
        details_edit=findViewById(R.id.editTextDetails1011p);
        save_button=findViewById(R.id.save_button_1011p);
        title_view=findViewById(R.id.title1011p);
        details_view=findViewById(R.id.details1011p);
    }
    @Override
    protected void onStart() {
        ...
        documentReference.addSnapshotListener(this,new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent( DocumentSnapshot documentSnapshot, FirebaseFirestoreException e) {
                if(e!=null){
                    Toast.makeText(Activity10_11p.this,"error",Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    public void save_data(View v){
        ...
        documentReference.set(dataOfEdittext).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                Toast.makeText(Activity10_11p.this,"Successfully saved",Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Activity10_11p.this,"Try again",Toast.LENGTH_SHORT).show();
            }
        });
