...
public class Activity2_3 extends AppCompatActivity {
    ...
    DocumentReference documentReference=db.collection("DATA").document(id).collection("2_3am").document("doc");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("2 AM - 3 AM");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        title_edit=findViewById(R.id.editTextTitle23);
        details_edit=findViewById(R.id.editTextDetails23);
        save_button=findViewById(R.id.save_button_23);
        title_view=findViewById(R.id.title23);
        details_view=findViewById(R.id.details23);
    }
    @Override
    protected void onStart() {
        ...
        documentReference.addSnapshotListener(this,new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent( DocumentSnapshot documentSnapshot, FirebaseFirestoreException e) {
                if(e!=null){
                    Toast.makeText(Activity2_3.this,"error",Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    public void save_data(View v){
        ...
        documentReference.set(dataOfEdittext).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                Toast.makeText(Activity2_3.this,"Successfully saved",Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Activity2_3.this,"Try again",Toast.LENGTH_SHORT).show();
            }
        });
