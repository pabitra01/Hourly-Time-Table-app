...
public class Activity8_9 extends AppCompatActivity {
    ...
    DocumentReference documentReference=db.collection("DATA").document(id).collection("8_9am").document("doc");


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_89);
        getSupportActionBar().setTitle("8 AM - 9 AM");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        mAdView = findViewById(R.id.adView);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);

        title_edit=findViewById(R.id.editTextTitle89);
        details_edit=findViewById(R.id.editTextDetails89);
        save_button=findViewById(R.id.save_button_89);
        title_view=findViewById(R.id.title89);
        details_view=findViewById(R.id.details89);
    }
    @Override
    protected void onStart() {
        ...
        documentReference.addSnapshotListener(this,new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent( DocumentSnapshot documentSnapshot, FirebaseFirestoreException e) {
                if(e!=null){
                    Toast.makeText(Activity8_9.this,"error",Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    public void save_data(View v){
        ...
        documentReference.set(dataOfEdittext).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                Toast.makeText(Activity8_9.this,"Successfully saved",Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Activity8_9.this,"Try again",Toast.LENGTH_SHORT).show();
            }
        });
