...
public class Activity3_4 extends AppCompatActivity {
    ...
    DocumentReference documentReference=db.collection("DATA").document(id).collection("3_4am").document("doc");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("3 AM - 4 AM");
        ...
        title_edit=findViewById(R.id.editTextTitle34);
        details_edit=findViewById(R.id.editTextDetails34);
        save_button=findViewById(R.id.save_button_34);
        title_view=findViewById(R.id.title34);
        details_view=findViewById(R.id.details34);
    }
    @Override
    protected void onStart() {
        ...
        documentReference.addSnapshotListener(this,new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent( DocumentSnapshot documentSnapshot, FirebaseFirestoreException e) {
                if(e!=null){
                    Toast.makeText(Activity3_4.this,"error",Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    public void save_data(View v){
        ...
        documentReference.set(dataOfEdittext).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                Toast.makeText(Activity3_4.this,"Successfully saved",Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Activity3_4.this,"Try again",Toast.LENGTH_SHORT).show();
            }
        });
