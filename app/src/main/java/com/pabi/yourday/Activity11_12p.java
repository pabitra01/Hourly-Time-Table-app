...
public class Activity11_12p extends AppCompatActivity {
    ...
    DocumentReference documentReference=db.collection("DATA").document(id).collection("11_12pm").document("doc");


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_activity1112p);
        getSupportActionBar().setTitle("11 PM - 12");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        mAdView = findViewById(R.id.adView);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);
        title_edit=findViewById(R.id.editTextTitle1112p);
        details_edit=findViewById(R.id.editTextDetails1112p);
        save_button=findViewById(R.id.save_button_1112p);
        title_view=findViewById(R.id.title1112p);
        details_view=findViewById(R.id.details1112p);
    }
    @Override
    protected void onStart() {
        ...
        documentReference.addSnapshotListener(this,new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent( DocumentSnapshot documentSnapshot, FirebaseFirestoreException e) {
                if(e!=null){
                    Toast.makeText(Activity11_12p.this,"error",Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    public void save_data(View v){
        ...
        documentReference.set(dataOfEdittext).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                Toast.makeText(Activity11_12p.this,"Successfully saved",Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Activity11_12p.this,"Try again",Toast.LENGTH_SHORT).show();
            }
        });
