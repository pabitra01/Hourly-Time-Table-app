...
public class Activity4_5 extends AppCompatActivity {
    ...
    DocumentReference documentReference=db.collection("DATA").document(id).collection("4_5am").document("doc");

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_45);
        getSupportActionBar().setTitle("4 AM - 5 AM");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        mAdView = findViewById(R.id.adView);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);

        title_edit=findViewById(R.id.editTextTitle45);
        details_edit=findViewById(R.id.editTextDetails45);
        save_button=findViewById(R.id.save_button_45);
        title_view=findViewById(R.id.title45);
        details_view=findViewById(R.id.details45);
    }
    @Override
    protected void onStart() {
        ...
        documentReference.addSnapshotListener(this,new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent( DocumentSnapshot documentSnapshot, FirebaseFirestoreException e) {
                if(e!=null){
                    Toast.makeText(Activity4_5.this,"error",Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    public void save_data(View v){
        ...
        documentReference.set(dataOfEdittext).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                Toast.makeText(Activity4_5.this,"Successfully saved",Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Activity4_5.this,"Try again",Toast.LENGTH_SHORT).show();
            }
        });
